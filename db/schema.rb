...
ActiveRecord::Schema.define(version: 20180313143441) do
  ...
  add_index "customers", ["birth_mday", "family_name_kana", "given_name_kana"], name: "index_cusotmers_on_birth_mday_and_furigana", using: :btree
  ...
  add_index "customers", ["birth_month", "family_name_kana", "given_name_kana"], name: "index_customers_on_birth_manth_and_furigana", using: :btree
  ...
  add_index "customers", ["birth_year", "family_name_kana", "given_name_kana"], name: "index_cusotmers_on_birth_year_and_furigana", using: :btree
